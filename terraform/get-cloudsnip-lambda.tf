resource "aws_lambda_function" "get_cloudsnip" {
  function_name = "getCloudSnip"
  ...
  filename         = "./zipped-lambdas/getCloudSnip.zip"
  source_code_hash = filebase64sha256("./zipped-lambdas/getCloudSnip.zip")
