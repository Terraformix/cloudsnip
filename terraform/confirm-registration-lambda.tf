resource "aws_lambda_function" "confirm_registration" {
  function_name = "confirmRegistration"
  ...
  filename         = "./zipped-lambdas/confirmRegistration.zip"
  source_code_hash = filebase64sha256("./zipped-lambdas/confirmRegistration.zip")
