resource "aws_lambda_function" "delete_cloudsnip" {
  function_name = "deleteCloudSnip"
  ...
  filename         = "./zipped-lambdas/deleteCloudSnip.zip"
  source_code_hash = filebase64sha256("./zipped-lambdas/deleteCloudSnip.zip")
