resource "aws_lambda_function" "get_user_profile_details" {
  function_name = "getUserProfileDetails"
  ...
  filename         = "./zipped-lambdas/getUserProfileDetails.zip"
  source_code_hash = filebase64sha256("./zipped-lambdas/getUserProfileDetails.zip")
