resource "aws_lambda_function" "cloudsnip_validation_processor" {
  function_name = "cloudSnipValidationProcessor"
  ...
  filename         = "./zipped-lambdas/cloudSnipValidationProcessor.zip"
  source_code_hash = filebase64sha256("./zipped-lambdas/cloudSnipValidationProcessor.zip")
