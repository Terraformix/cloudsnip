resource "aws_lambda_function" "update_cloudsnip_status" {
  function_name = "updateCloudSnipStatus"
  ...
  filename         = "./zipped-lambdas/updateCloudSnipStatus.zip"
  source_code_hash = filebase64sha256("./zipped-lambdas/updateCloudSnipStatus.zip")
